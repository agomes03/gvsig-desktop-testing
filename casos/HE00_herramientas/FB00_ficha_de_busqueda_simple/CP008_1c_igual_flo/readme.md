## HE00FB00CP008 Busqueda de un campo float 
...
Cargamos el fichero de datos y comprobamos que seleccionando un valor dentro del campo de tipo float me escoge el registro correcto. El resultado final es correcto.
...
3. Seleccionaremos el campo "Float" de la lista de campos
...
[Abro una nueva publicacion con este test](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP008+Busqueda+de+un+campo+float)
[](readme.md)