...
Cargamos el fichero de datos y comprobamos que seleccionando un valor dentro del campo decimal me escoge el registro correcto. El resultado final es correcto.
