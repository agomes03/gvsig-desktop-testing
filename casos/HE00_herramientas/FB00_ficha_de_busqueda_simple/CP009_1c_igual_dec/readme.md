## HE00FB00CP009 Busqueda de un campo decimal 
...
Cargamos el fichero de datos y comprobamos que seleccionando un valor dentro del campo de tipo decimal me escoge el registro correcto. El resultado final es correcto.
...
3. Seleccionaremos el campo "Decimal" de la lista de campos
...
[Abro una nueva publicacion con este test](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP009+Busqueda+de+un+campo+decimal)
[](readme.md)