## HE00FB00CP022 Mostrar una columna que no se visualiza en la ficha de busqueda 
...
[Abro una nueva publicacion con este test](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP022+Mostrar+una+columna+que+no+se+visualiza+en+la+ficha+de+busqueda)
[](readme.md)