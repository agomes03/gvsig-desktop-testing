...
3. Seleccionaremos el campo "Time" de la lista de campos
4. Seleccionaremos el operador "Menor que" de la lista de operadores logicos
5. Seleccionaremos el valor "18:13:14"
6. Pulsaremos en el boton "Buscar"

### Resultados esperados

Como resultado de la busqueda obtendremos 6 resultados con el "ID":
...
[Abro una nueva publicacion con este test](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP011+Busqueda+de+un+campo+time)
[](readme.md)