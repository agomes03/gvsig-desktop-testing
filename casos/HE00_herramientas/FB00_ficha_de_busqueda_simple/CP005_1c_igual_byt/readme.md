...
Cargamos el fichero de datos y comprobamos que seleccionando un valor dentro del campo byte me escoge el registro correcto. El resultado final es correcto.
