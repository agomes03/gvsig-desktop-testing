## HE00FB00CP019 Crear una columna calculada nueva a partir de datos de columnas existentes 
...
[Abro una nueva publicacion con este test](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP019+Crear+una+columna+calculada++nueva+a+partir+de+datos+de+columnas+existentes)
[](readme.md)