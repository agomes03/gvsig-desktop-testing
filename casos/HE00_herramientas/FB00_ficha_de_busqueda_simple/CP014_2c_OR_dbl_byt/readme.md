## HE00FB00CP014 Busqueda de dos campos double y byte 
...
4. Seleccionaremos el campo "Double" de la lista de campos
5. Escogeremos el operador logico "O" de la lista de operadores logicos
6. Seleccionaremos el segundo campo "Byte" de la lista de campos
...
[Abro una nueva publicacion con este test](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP014+Busqueda+de+dos+campos+double+y+byte)
[](readme.md)