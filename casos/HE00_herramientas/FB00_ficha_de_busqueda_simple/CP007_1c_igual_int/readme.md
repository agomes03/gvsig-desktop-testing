## HE00FB00CP007 Busqueda de un campo integer 
...
Cargamos el fichero de datos y comprobamos que seleccionando un valor dentro del campo integer me escoge el registro correcto. El resultado final es correcto.
...
3. Seleccionaremos el campo "ID" de la lista de campos
...
[Abro una nueva publicacion con este test](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP007+Busqueda+de+un+campo+integer)
[](readme.md)