## HE00FB00CP013 Busqueda de dos campos de tipo string y de tipo integer en un shapefile
...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP013+Busqueda+de+dos+campos+de+tipo+string+y+de+tipo+integer+en+un+shapefile)
[](readme.md)