## HE00FB00CP013 Busqueda de dos campos de tipo string y de tipo integer con el operador logico "AND" en un shapefile
...
Cargamos el fichero de datos y comprobamos que seleccionando un valor dentro del campo de tipo string y otor valor dentro del campo de tipo integer me escoge el registro correcto. El resultado final es correcto.
...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP013+Busqueda+de+dos+campos+de+tipo+string+y+de+tipo+integer+con+el+operador+logico+"AND"+en+un+shapefile)
[](readme.md)