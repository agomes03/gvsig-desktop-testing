...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP020+Crear+una+columna+nueva+a+partir+de+datos+de+columnas+existentes+en+un+shapefile)
[](readme.md)