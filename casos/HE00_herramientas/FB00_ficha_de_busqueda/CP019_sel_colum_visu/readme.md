## HE00FB00CP020 Crear una columna nueva a partir de datos de columnas existentes en un shapefile
...
Cargamos el fichero de datos e creamos una columna nueva a partir de una columna de tipo string correctamente El resultado final no es correcto.
...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP020+Crear+una+columna+nueva+tipo+a+partir+de+datos+de+columnas+existentes+en+un+shapefile)
[](readme.md)