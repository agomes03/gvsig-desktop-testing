...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP019+Mostrar+una+columna+de+tipo+long+que+no+se+visualiza+en+la+ficha+de+busqueda+en+un+shapefile)
[](readme.md)