## HE00FB00CP006 Busqueda de un campo de tipo boleano en un shapefile
...
3. Seleccionaremos el campo "Bool1"
...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP006+Busqueda+de+un+campo+de+tipo+boleano+en+un+shapefile)
[](readme.md)