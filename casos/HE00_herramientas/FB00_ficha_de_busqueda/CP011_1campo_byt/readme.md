## HE00FB00CP011 Busqueda de un campo de tipo byte en un shapefile
...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP011+Busqueda+de+un+campo+de+tipo+byte+en+un+shapefile)
[](readme.md)