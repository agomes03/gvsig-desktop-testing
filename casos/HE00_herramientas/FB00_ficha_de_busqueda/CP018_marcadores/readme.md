## HE00FB00CP018 Añadir a marcadores un valor de un campo de tipo integer en un shapefile
...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP018+Añadir+a+marcadores+un+valor+de+un+campo+de+tipo+integer+en+un+shapefile)
[](readme.md)