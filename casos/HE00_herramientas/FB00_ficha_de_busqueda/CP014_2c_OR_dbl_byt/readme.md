## HE00FB00CP014 Busqueda de dos campos de tipo double y de tipo byte en un shapefile
...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP014+Busqueda+de+dos+campos+de+tipo+double+y+de+tipo+byte+en+un+shapefile)
[](readme.md)