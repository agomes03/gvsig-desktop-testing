## HE00FB00CP017 Probando el historial de busqueda con un campo de tipo string en un shapefile
...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP017+Probando+el+historial+de+busqueda+con+un+campo+de+tipo+string+en+un+shapefile)
[](readme.md)