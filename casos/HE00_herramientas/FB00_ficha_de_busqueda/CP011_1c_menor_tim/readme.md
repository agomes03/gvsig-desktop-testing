## HE00FB00CP011 Busqueda de un campo de tipo time en un shapefile
...
3. Seleccionaremos el campo "Time"
4. Seleccionaremos el operador "Menor que"
...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP011+Busqueda+de+un+campo+de+tipo+time+en+un+shapefile)
[](readme.md)