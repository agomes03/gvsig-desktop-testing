...
[Abro una nueva publicacion a esta prueba](https://redmine.gvsig.net/redmine/projects/gvsig-desktop/issues/new?issue[subject]=HE00FB00CP002+Busqueda+de+un+campo+de+tipo+string+en+un+shapefile)
[](readme.md)